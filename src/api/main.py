"""Sales Analytics Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Sales analytics agent that tracks pipeline health, analyzes win/loss patterns, forecasts revenue, identifies deal risks, and provides rep performance benchmarking with coaching insights.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
